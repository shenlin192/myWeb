 ...
 */
(0, _jquery2.default)('input[type="text"],input[type="password"],input[type="email"]').on('focus', function () {
    (0, _jquery2.default)(undefined).prev().animate({ 'opacity': '1' }, 200);
}).on('blur', function () {
    (0, _jquery2.default)(undefined).prev().animate({ 'opacity': '.5' }, 200);
}).on('keyup', function () {
    if (!(0, _jquery2.default)(undefined).val() == '') {
        (0, _jquery2.default)(undefined).next().animate({ 'opacity': '1', 'right': '30' }, 200);
    } else {
        (0, _jquery2.default)(undefined).next().animate({ 'opacity': '0', 'right': '20' }, 200);
    }
});
...
if (window.DeviceOrientationEvent) {
    ...
    window.addEventListener('deviceorientation', function (event) {
        ...
        if (flag) {
            ...
            (0, _jquery2.default)('body').stop().animate({
