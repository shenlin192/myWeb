...
/* For react demo */
router.get('/investisseur/investor_info/', (req, res, next) => {
  res.json({
    count: 1,
    next: null,
    previous: null,
...
router.get('/investisseur/resa/', (req, res, next) => {
  res.json({
    count: 25,
...
router.get('/user_management/suivi_projects/', (req, res, next) => {
  res.json({
    count: 15,
...
router.get('/user_management/own_project/', (req, res, next) => {
  res.json({
    count: 1,
    next: null,
    previous: null,
...
router.get('/investisseur/investment/', (req, res, next) => {
  res.json({
    count: 5,
    next: null,
    previous: null,
